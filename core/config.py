...
__C.TRACK_SCORE_THRESH=0.1
__C.TRACK_MAX_DIST=20

__C.CHOOSE_PROPOSAL=True
__C.STRIDE=8
__C.TEMP_MIN_SIZE=64
__C.TEMP_MAX_SIZE=448
__C.TEMP_NUM=5
...
__C.TRAIN.TRACK_RPN_POSITIVE_THRESH = 0.6
# IOU < thresh: negative example
__C.TRAIN.RPN_NEGATIVE_THRESH = 0.3
__C.TRAIN.TRACK_RPN_NEGATIVE_THRESH = 0.25
...
__C.TEST.TRACK_RPN_POSITIVE_THRESH = 0.6
# IOU < thresh: negative example
__C.TEST.TRACK_RPN_NEGATIVE_THRESH = 0.3
