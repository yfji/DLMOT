...
#    def forward(self, temp_image, det_image, temp_box, search_box):
    def forward(self, roidbs):
        ...
        temp_box_roi_feat=crop_and_resize((self.temp_roi_size,self.temp_roi_size), z, Variable(temp_boxes), box_inds)
        det_box_roi_feat=crop_and_resize((self.det_roi_size,self.det_roi_size), x, Variable(search_boxes), box_inds)
