...
#            print(ref_classes_align)
#            print(det_classes_align)
            good_inds=[]
            if len(ref_boxes_align)>0:
                ...
                track_anchors=G.gen_region_anchors(self.track_raw_anchors, search_boxes, bound, K=self.TK, size=(self.roi_size,self.roi_size)) 
                '''track anchors'''
